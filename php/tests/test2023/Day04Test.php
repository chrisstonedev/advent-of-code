...
class Day04Test extends TestCase
{
    ...
    {
        return [
            'test' => [sprintf("2023_%s_test", self::DAY_NUMBER), 13],
            'input' => [sprintf("2023_%s_input", self::DAY_NUMBER), 28750],
        ];
    }
    ...
    {
        return [
            'test' => [sprintf("2023_%s_test", self::DAY_NUMBER), 30],
            'input' => [sprintf("2023_%s_input", self::DAY_NUMBER), 10212704],
        ];
    }
}