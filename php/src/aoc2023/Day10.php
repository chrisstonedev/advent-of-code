...
class Day10
{
    const array FACE_RIGHT = ['-', 'L', 'F'];
    const array FACE_LEFT = ['-', 'J', '7'];
    const array FACE_UP = ['|', 'L', 'J'];
    const array FACE_DOWN = ['|', '7', 'F'];
    const int ENCLOSED_SEARCH_OUTSIDE = 0;
    const int ENCLOSED_SEARCH_ON_THE_WAY_IN_FROM_BOTTOM = 1;
    const int ENCLOSED_SEARCH_ON_THE_WAY_IN_FROM_TOP = 2;
    const int ENCLOSED_SEARCH_INSIDE = 3;
    const int ENCLOSED_SEARCH_ON_THE_WAY_OUT_FROM_TOP = 4;
    const int ENCLOSED_SEARCH_ON_THE_WAY_OUT_FROM_BOTTOM = 5;
